...
DATA.X=Pks.X;                     % Ndat x 2 array of covariate values
DATA.Y=Pks.Y;                     % Ndat x 1 array of response values
DATA.name.dataset='NorthSea';     % Name of dataset
...
DATA.grid.Nnearest=50;            % Number of nearest points for threshold and GP estimates
DATA.grid.KD_bw=10;               % Bandwidth for kernel density estimate of covariate joint PDF
DATA.grid.Thresh_binwidth=10;     % Bandwidth for Gaussian smoothing kernel for threshold
DATA.grid.sigma_binwidth=10;      % Bandwidth for Gaussian smoothing kernel for threshold
...
figure
plot_initial_gridded_estimates_2cov(DATA,'thresh_raw',1)

figure
plot_initial_gridded_estimates_2cov(DATA,'sigma',1)

figure
plot_initial_gridded_estimates_2cov(DATA,'sigma_raw',1)
